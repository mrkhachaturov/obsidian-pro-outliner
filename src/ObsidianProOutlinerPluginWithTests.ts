...
export default class ObsidianProOutlinerPluginWithTests extends ObsidianProOutlinerPlugin {
  ...
  async load() {
    ...
    (window as any).ObsidianProOutlinerPlugin = this;
  ...
  async onunload() {
    ...
    delete (window as any).ObsidianProOutlinerPlugin;
  }
